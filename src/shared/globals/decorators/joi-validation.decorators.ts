//hacer abstracciones de validación de los esquemas de datos para luego inyectarlos
//mediante inyección de dependencias cuando manipule la lógica de negocio
